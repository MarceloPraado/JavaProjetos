...
public class Temperatura {
	...
	public static void main(String[] args) {
		...
		System.out.println("Sua temperatura de " + Celsius + " Graus Celsius é o Equivalente a: " + Kelvin + " Na escala Kelvin; " + Fahrenreit + " Na escala Fahrenheit; " + Reaumur + " Na escala de Reaumur; " + " E " + Rankine + " Na escala Rankine. ");
